    ...
    return (
        <div className='Hamburger-box'>
            ...
            <div className='hamburger-nav'>
                ...
                <IoIosSearch onClick={handleSearch} fontSize="40px" />
                <img onClick={homeHandle} src={logo} alt="" className='hamburger-log' />
                <BsPersonCircle onClick={profileHandle} fontSize="35px" />
                <BsBag onClick={cartHandle} fontSize="35px" />
            </div>
            <Drawer
                isOpen={isOpen}
                placement='left'
